...
#yay looks good now lets do some tree magic 
...
# seperate into aboveground data (stem) and belowground (roots)
...
#detrend data and make chronologies for aboveground and belowground data 
...
#aboveground chronology use chron.stabalize b/c small sample size 
